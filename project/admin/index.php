<?php
    ...
    if(isset($_GET['act'])){
        ...
        switch ($act) {
            ...
            case 'dskh':
                $listTaiKhoan = loadAll_taikhoankh();
            ...
            //NHAN VIEN - TAI KHOAN
            case 'dsnv':
                $listTaiKhoannv = loadAll_taikhoannv();
                include "tknhanvien/list.php";
                break;
            case 'addnv':
                ...
                if (isset($_POST['themmoi']) && ($_POST['themmoi'])) {
                    ...
                    $sdt = $_POST['sdt'];       
                    $role = 2;
                    insert_taikhoan_nv($tentk, $matkhau, $email, $diachi, $sdt, $role);
                    $thongbao = "Thêm tài khoản thành công.";
                }
                $listTaiKhoannv = loadAll_taikhoan();
                // var_dump($listdanhmuc);
                include "tknhanvien/add.php";
                break;
            case 'xoanv':
                if(isset($_GET['id']) && ($_GET['id']> 0)){
                    delete_taikhoan($_GET['id']);
            ...
            case 'suanv':
                if(isset($_GET['id']) && ($_GET['id']> 0)){
                    $taikhoannv= loadone_taikhoan($_GET['id']);
                }
                // $listTaiKhoan= loadAll_taikhoan();
                include "tknhanvien/update.php";
                break;
            case 'updatenv':
                if(isset($_POST['capnhat']) && ($_POST['capnhat'])){
                    $id= $_POST['id'];
