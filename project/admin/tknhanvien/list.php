    ...
    <div class="row frmcontent">
        <div class="row m10 frmdsloai">
            <table>
                ...
                <?php
                    foreach($listTaiKhoannv as $taiKhoannv){
                        extract($taiKhoannv);
                        $suaTK= "index.php?act=suanv&id=".$id;
                        $xoaTK= "index.php?act=xoanv&id=".$id;
                        echo '<tr>
        ...
        <div class="row mb10-btn">
            ...
            <a href="index.php?act=addnv"><input type="button" value="Nhập thêm"></a>
        </div>
        <hr class="hr-pub end"> 
    </div>
    </div>
